 ...
 * Crates are moved multiple crates at once.
 *
...
//            System.out.println("move " + createsToMove + " from " + fromstacks + " to " + tostacks);
            ...
            stackAddto = stackAddto + stackRemoveFrom.substring(stackRemoveFrom.length() - createsToMove, stackRemoveFrom.length());
            stackRemoveFrom = stackRemoveFrom.substring(0, stackRemoveFrom.length() - createsToMove);
